...
class Hestia_Public {
	...
	public function enqueue_scripts() {
		...
		wp_style_add_data( 'custom', 'rtl', 'replace' );
		wp_style_add_data( 'custom', 'suffix', '.min' );
	...
	public function setup_theme() {
		...
		$custom_background_settings = array(
			'default-color' => apply_filters( 'hestia_default_background_color', '#212121' ),
		);
			...
			apply_filters(
				...
				array(
					...
					2 => array(
						...
						'slug'  => 'accent',
						'color' => get_theme_mod( 'accent_color', '#fecc09' ),
					),
					4 => array(
						'name'  => esc_html__( 'Body', 'hestia' ),
						'slug'  => 'background_color',
						'color' => '#' . get_theme_mod( 'background_color', '#212121' ),
					),
					5 => array(
						'name'  => esc_html__( 'Header Background', 'hestia' ),
						'slug'  => 'header-gradient',
						'color' => get_theme_mod( 'hestia_header_gradient_color', '#212121' ),
					),
				)
			)
		);
