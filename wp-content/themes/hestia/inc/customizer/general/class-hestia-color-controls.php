	...
	public function add_controls() {
		$this->add_control(
			new Hestia_Customizer_Control(
				'accent_color',
				array(
					'default'           => apply_filters( 'hestia_accent_color_default', '#fecc09' ),
		...
		$this->add_control(
			new Hestia_Customizer_Control(
				...
				array(
					'default'           => apply_filters( 'hestia_header_gradient_default', '#212121' ),
					'transport'         => 'postMessage',
					'sanitize_callback' => 'hestia_sanitize_colors',
				),
				array(
					'label'    => esc_html__( 'Header Color', 'hestia' ),
