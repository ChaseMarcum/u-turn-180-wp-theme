...
/**
 * Hook after the secondary button in Big Title Section
 *
 * HTML context: inside `div.big-title-content div.buttons`
 *
 * @param bool | int $slide_nb Current slide number.
 */
function hestia_big_title_section_secondary_buttons_trigger( $slide_nb = false ) {
	do_action( 'hestia_big_title_section_secondary_buttons', $slide_nb );
}
