...
final class Hestia_Content_Import {
	...
	private $simple_theme_mods = array(
		...
		'hestia_big_title_secondary_button_text' => 'header_secondary_button_text',
		'hestia_big_title_secondary_button_link' => 'header_secondary_button_link',
	...
	private function import_content() {
		...
		$settings = array(
			...
			'secondary_text'      => $prefix . 'header_secondary_button_text',
			'secondary_link'      => $prefix . 'header_secondary_button_link',
